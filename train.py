...
if __name__ == "__main__":
    ...
    # parser.add_argument('--lambda_rec',type=float,default=0.1,help='lambda for reconstruction net')
    parser.add_argument('--lambda_lr_consistency',type=float,default=10,help='lambda for lr cycle loss')
    parser.add_argument('--lambda_warp_consistency',type=float,default=10,help='lambda for cycle depth consistency')
